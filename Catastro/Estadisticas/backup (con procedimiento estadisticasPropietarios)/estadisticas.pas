...
procedure quitarRepetidos(var arr:tArrayMaxPropietarios; var size:word);
...
begin
	...
	begin
		...
		begin
			...
			//writeln(Propietario.numeroContribuyente);
			cantidad += 1;
			if (length(Propietario.numeroContribuyente)=10) and (Propietario.numeroContribuyente <> '0000000000') then begin cambiarEstado(archivoPropietarios, archivoTerrenos, i); arrayPropietarios[cantidad] := Propietario.numeroContribuyente; end;
			//end;
	...
	quitarRepetidos(arrayPropietarios, cantidadContada);
	//quitarRepetidos(arrayPropietarios, cantidadContada);
...
var i, j:word;
totalPropietarios, totalTerrenosArchivo, propietariosMasUnoTerrenos, dadosDeBaja:word;
...
var totalPropietarios, propietariosMasUnoTerrenos, dadosDeBaja:word;
arrayPropietarios:tArrayMaxPropietarios;
begin
	...
	writeln(propietariosMasUnoTerrenos);
	
	if totalPropietarios <> 0 then
	begin
		textcolor(yellow);
		gotoxy(25, 16);
		writeln('* Porcentaje: ', propietariosMasUnoTerrenos/totalPropietarios*100:3:2, '%');
		textcolor(white);
	end;
...
/////////////////		ACOMODAR A (AAAA/MM/DD)		//////////////////////////
	...
	//contarCantidadTerrenosEntreFechas(archivoPropietarios, archivoTerrenos, fechaBusquedaInscripcionInicial, fechaBusquedaInscripcionFinal, cantidadTerrenos);
...
var totalPropietarios, totalTerrenosArchivo, dadosDeBaja, propietariosMasUnoTerrenos, i, j:word;
arrayPropietarios:tArrayMaxPropietarios;
Propietario:tDatoPropietarios;
cantidadTerrenos:word;
